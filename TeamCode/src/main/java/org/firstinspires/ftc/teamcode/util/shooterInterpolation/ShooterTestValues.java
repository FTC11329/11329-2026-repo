...
public class ShooterTestValues implements ShooterValuesParent {
    ...
    public ShooterTestValues() {
        ...
        shooterMap.put(75. + ADDITION + CLOSE_ADDITION, new ShooterState(2400 * RPM_MULTIPLYER,36,0.626));
        ...
        shooterMap.put(115 + FAR_ADDITION, new ShooterState(2870 * RPM_MULTIPLYER,38+ FAR_ANGLE_ADDITION,0.834));
        shooterMap.put(125. + FAR_ADDITION, new ShooterState(3030 * RPM_MULTIPLYER,39.3+ FAR_ANGLE_ADDITION,0.922));
        shooterMap.put(135. + FAR_ADDITION, new ShooterState(3100 * RPM_MULTIPLYER,36.5+ FAR_ANGLE_ADDITION,0.916));
        shooterMap.put(145. + FAR_ADDITION, new ShooterState(3240 * RPM_MULTIPLYER,38+ FAR_ANGLE_ADDITION,0.956));
        shooterMap.put(155. + FAR_ADDITION, new ShooterState(3400 * RPM_MULTIPLYER,38+ FAR_ANGLE_ADDITION,0.940));
        shooterMap.put(165.+ FAR_ADDITION, new ShooterState(3530 * RPM_MULTIPLYER,40.5+ FAR_ANGLE_ADDITION, 0.972));
    }
