...
@Autonomous(name = "CRI Red Close 21", group = "00Comp", preselectTeleOp = "Main Teleop Red")
public class CRIRedClose21 extends OpMode {
    Pose startPose;
    RobotSide robotSide;
    Robot robot;
    ...
    public void init() {
        ...
        steps.add(new FromShootMidPos.ToIntakeFromRamp(robot, lastPlanner(), false, false, true, false));
        steps.add(new FromShootMidPos.ToIntakeFromRamp(robot, lastPlanner(), false, false, true, true));
        steps.add(new FromShootMidPos.ToIntakeFromRamp(robot, lastPlanner(), false, false, true, false));
        steps.add(new FromShootMidPos.ToIntakeFromRamp(robot, lastPlanner(), false, false, true, false));
        steps.add(new FromShootMidPos.ToIntakeFromRamp(robot, lastPlanner(), false, false, true, false));
