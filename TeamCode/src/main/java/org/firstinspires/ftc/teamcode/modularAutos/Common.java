...
//    public static Pose toRedOffset = new Pose(-2.25,-0.75,0); // red offset remember y is reversed
    ...
    public static class StartPoses {
        ...
        public static Pose reZeroAtCorner = new Pose(-76, -85, Math.toRadians(-90));
        public static Pose farZoneAutoPark = new Pose(-72, 36, Math.toRadians(90));
        public static Pose closePark = new Pose(36, 62, Math.toRadians(90));
    ...
    public static class IntakeBallPoses {
        public static Pose intakeSpike1ControlPoint = new Pose(-12.2, 44.9, Math.toRadians(90));
        public static Pose intakeSpike1Start = new Pose(11.5, 56, Math.toRadians(90));
        public static Pose intakeSpike1End = new Pose(11.5, 79, Math.toRadians(90));

        public static Pose intakeSpike2ControlPoint = new Pose(-35.7,43.8, Math.toRadians(90));
        public static Pose intakeSpike2Start = new Pose(-35.75, 56, Math.toRadians(90));
        public static Pose intakeSpike2End = new Pose(-35.75, 87, Math.toRadians(90));

        public static Pose intakeSpike3ControlPoint = new Pose(-34.1, 38.9, Math.toRadians(90));
        public static Pose intakeSpike3StartClose = new Pose(-54.5, 56, Math.toRadians(90));
        public static Pose intakeSpike3StartFar = new Pose(-63, 56, Math.toRadians(90));
        public static Pose intakeSpike3End = new Pose(-60, 88, Math.toRadians(90));

        public static Pose intakeSpike1FastControlPoint = new Pose(26.7,71.5);
        public static Pose intakeSpike1Fast = new Pose(16.8,71.5, Math.toRadians(180));

        public static Pose intakeSpike2FastControlPoint = new Pose(2.6,72);
        public static Pose intakeSpike2Fast = new Pose(-7.9,72, Math.toRadians(180));

        public static Pose intakeSpike3FastControlPoint = new Pose(-9,71.9);
        public static Pose intakeSpike3Fast = new Pose(-31.1,71.9, Math.toRadians(180));

        public static Pose movingToPushLeverControlPoint = new Pose(21.8, 73.3);
        public static Pose prePushLeverAfterSpike1 = new Pose(30,77, Math.toRadians(90));
        public static Pose pushLeverAfterSpike1 = new Pose(30,80.1, Math.toRadians(90));
        public static Pose pushLeverAfterSpike2 = new Pose(22,80, Math.toRadians(90));
        public static Pose pushLever = new Pose(-14, 86, Math.toRadians(63));
        public static Pose intakeFromSTunnel = new Pose(7, 82.25, Math.toRadians(45)); // pointing at ramp

        public static Pose toIntakeHumanStart = new Pose(-85.5,48, Math.toRadians(90));
        public static Pose intakeHumanDiag = new Pose(-85.5,84, Math.toRadians(120));
        public static Pose intakeHuman = new Pose(-87,90, Math.toRadians(90));
        public static Pose intakeSTunnelAfterHumanControl = new Pose(-80.4,79.8);
        public static Pose intakeSTunnelAfterHuman = new Pose(-73.6,86.9, Math.toRadians(0));
        ...
        static void convert(boolean toRed) {
            ...
            intakeHumanDiag = convertToRed(intakeHumanDiag, toRed);
            toIntakeHumanStart = convertToRed(toIntakeHumanStart, toRed);
    ...
    public static class ShootPoses {
        ...
        public static Pose closeShoot = new Pose(60, 60, Math.toRadians(90));
        public static Pose midShoot =   new Pose(32.9,42.5, Math.toRadians(90));
        public static Pose farShoot =   new Pose(-80.4, 44.7, Math.toRadians(85));

        public static Pose fromStartCloseToMidShootControl = new Pose(69.3,73.6);

        public static Pose panicShoot = new Pose(-72, 72);

        public static Pose optimalSpike1Start = new Pose(28.03,35.9, Math.toRadians(116));
        public static Pose optimalSpike2Start = new Pose(30.18,38.25, Math.toRadians(146));
        public static Pose optimalSpike3Start = new Pose(33.24,37.25, Math.toRadians(155));
        public static Pose optimalRampStart = new Pose(30.4,39.88, Math.toRadians(106));
        ...
        public static Pose optimalLeverStart =  new Pose(38.7, 49.6, Math.toRadians(135));

        public static Pose optimalSpike2StartFar = new Pose(-76.5,20.2, Math.toRadians(20));
        public static Pose optimalSpike3StartFar = new Pose(-76.5,18.9, Math.toRadians(76));
        public static Pose optimalVisionStartFar = new Pose(-80.2,13, Math.toRadians(95));
