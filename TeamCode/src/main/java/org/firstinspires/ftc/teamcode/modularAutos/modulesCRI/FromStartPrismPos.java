...
import static org.firstinspires.ftc.teamcode.modularAutos.CommonCRI.DrivePower;
import static org.firstinspires.ftc.teamcode.modularAutos.CommonCRI.ShootPoses;
import static org.firstinspires.ftc.teamcode.modularAutos.CommonCRI.StartPoses;
import static org.firstinspires.ftc.teamcode.modularAutos.CommonCRI.TValues;
import static org.firstinspires.ftc.teamcode.modularAutos.CommonCRI.Timings;
...
public class FromStartPrismPos {
    ...
    public static class ShootAndGoToMidShootPos implements PathPlanner {
        ...
        public void buildPaths() {
            // Path creation
            toShootPosition = robot.follower.fastPathChainBuilder(startPose, lastPose, TValues.fastInterpolationPreloadStart, TValues.fastInterpolationPreloadEnd, false);
        }
    ...
    public static class ShootAndGoToMidShootPosFast implements PathPlanner {
        ...
        public ShootAndGoToMidShootPosFast(Robot robot, PathPlanner prevPlanner, boolean distant) {
            pathTimer = new Timer();
            this.distant = distant;
            this.robot = robot;
            this.startPose = prevPlanner.getEndPoseEst();
            this.lastPose = distant ? ShootPoses.distantShoot : ShootPoses.midShoot;
        }
