...
public enum CloseAutoPhases {
    run, prepShot1, shoot1, moveToIntake1, intaking1, stillIntaking1, goToShoot2, shoot2,
    ...
    moveToSTunnel, intakingSTunnel, stillIntaking4, outtake, goToShoot5, shoot5,
