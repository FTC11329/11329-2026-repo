...
public class ColorRangeFinder {
    ...
    public void setPin1Analog(AnalogMode analogMode, int denominator) {
        byte denom0 = (byte) (denominator & 0xFF);
        byte denom1 = (byte) ((denominator & 0xFF00) >> 8);
        i2c.write(PinNum.PIN1.modeAddress, new byte[]{analogMode.value, denom0, denom1});
    }
    ...
    public void setPin1Analog(AnalogMode analogMode) {
        setPin1Analog(analogMode, analogMode == AnalogMode.DISTANCE ? 100 : 0xFFFF);
    }
