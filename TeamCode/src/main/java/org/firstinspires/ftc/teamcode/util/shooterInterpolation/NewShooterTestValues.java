...
public class NewShooterTestValues implements ShooterValuesParent{
    ...
    public NewShooterTestValues() {
        ...
        shooterMap.put(85.47, new ShooterState(2828, 40.1, 0.52)); //0
        shooterMap.put(90.3, new ShooterState(2944, 40.1, 0.51)); //0
        shooterMap.put(95.2, new ShooterState(3076, 40.1, 0.5)); //0
        shooterMap.put(99.8, new ShooterState(3112, 38, 0.55)); //0
        shooterMap.put(108.75, new ShooterState(3236, 38.6, 0.57)); //0
        shooterMap.put(113.16, new ShooterState(3236, 38.6, 0.65)); //0
