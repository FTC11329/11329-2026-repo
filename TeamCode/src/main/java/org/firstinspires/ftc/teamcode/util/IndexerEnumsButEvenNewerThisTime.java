...
public enum IndexerEnumsButEvenNewerThisTime {
    ...
    // 2   1 | 0   2 | 1   0 | 2   1 |
    //   0   |   1   |   2   |   0   |
    public static IndexerEnumsButEvenNewerThisTime getEnum(int index, boolean shootIndex) {
        if (!shootIndex) {
            switch (index) {
                case 0:
                    return intake0;
    ...
    public static boolean isAShootEnum(IndexerEnumsButEvenNewerThisTime indexerPos) {
        switch (indexerPos) {
            case shoot0:
            case shoot1:
            case shoot2:
